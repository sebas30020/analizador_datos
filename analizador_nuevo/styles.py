...
APP_QSS = """
    ...
    QRadioButton#RbtTargetA {
        color: #00E5FF;
        font-weight: bold;
    }
    QRadioButton#RbtTargetB {
        color: #FF1744;
        font-weight: bold;
    }
    QRadioButton#RbtTargetA:disabled {
        color: #005E66;
    }
    QRadioButton#RbtTargetB:disabled {
        color: #8C142B;
    }
    ...
    QRadioButton#RbtTargetA::indicator:checked {
        background: #00E5FF;
        border-color: #00E5FF;
    }
    QRadioButton#RbtTargetB::indicator:checked {
        background: #FF1744;
        border-color: #FF1744;
    }
